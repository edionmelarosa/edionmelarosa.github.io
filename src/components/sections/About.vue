<template>
    <section id="about">
        <p>Hello, I'm Edion Larosa. Im Web Developer from Philippines. 
        ...
        <a class="icon" target="_blank" href="https://www.linkedin.com/in/espiridion-larosa-2a1316a3/">
        <i class="fab fa-linkedin"></i></a>
        <span>and</span>
        <a class="icon" target="_blank" href="mailto:edion.larosa@email.com">
